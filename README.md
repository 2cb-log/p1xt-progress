...
#### Main goal:  Be job-ready as a Front-End Developer.  

While I'm a firm believer in having a solid foundation of concepts and principles, the marketplace hires on tools and skills so there will be a reality-based weighting towards investigating and building/with:
  1. portfolio projects
  1. frameworks and tool chains

As for fulfilling a goal of "build a deeper foundation" in mathematics, the sciences, art, etc., my aim is to complete two college courses and I'm fine starting out not being entirely sure which those will be.
...
## Software Engineering Books / Texts
